...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::contacts::contact, _impl_.sn_),
  PROTOBUF_FIELD_OFFSET(::contacts::contact, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::contacts::contact, _impl_.score_),
};
...
void contact::InternalSwap(contact* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(contact, _impl_.score_)
      + sizeof(contact::_impl_.score_)
      - PROTOBUF_FIELD_OFFSET(contact, _impl_.sn_)>(
